...
class Loan(models.Model, CurrencyConversionMixin, InterestCalculationMixin):
    ...
    amount_taken_lcy = models.DecimalField(max_digits=20, decimal_places=2, default=Decimal("0.00"))
    ...
    interest_rate = models.DecimalField(max_digits=4, decimal_places=2, default=Decimal("12.50"), help_text="Annual interest rate in percentage.")
    interest = models.DecimalField(max_digits=20, decimal_places=2, default=Decimal("0.00"), editable=False)
    interest_lcy = models.DecimalField(max_digits=20, decimal_places=2, default=Decimal("0.00"), editable=False)
    in_default = models.BooleanField(default=False)
    amount_repay = models.DecimalField(max_digits=20, decimal_places=2, default=Decimal("0.00"))
    amount_repay_lcy = models.DecimalField(max_digits=20, decimal_places=2, default=Decimal("0.00"))
    amount_paid = models.DecimalField(max_digits=20, decimal_places=2, default=Decimal("0.00"))
    amount_paid_lcy = models.DecimalField(max_digits=20, decimal_places=2, default=Decimal("0.00"))
    due_balance = models.DecimalField(max_digits=20, decimal_places=2, default=Decimal("0.00"))
    due_balance_lcy = models.DecimalField(max_digits=20, decimal_places=2, default=Decimal("0.00"))

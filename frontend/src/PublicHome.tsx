  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-linear-to-br from-indigo-50 via-white to-indigo-100 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 px-4">
        ...
        <Card className="text-center shadow-2xl border border-border/50 bg-white/70 dark:bg-gray-950/60 backdrop-blur-lg">
          <CardHeader>
            <div className="flex justify-center mb-2">
              <div className="p-4 rounded-full bg-linear-to-br from-indigo-500 to-purple-500 text-white shadow-md">
          ...
          <CardContent className="space-y-6">
            <p className="text-muted-foreground text-lg leading-relaxed">
              Track your income, monitor expenses, and visualize your financial
              growth — all in one intuitive dashboard built to help you achieve
              financial freedom.
            </p>
      ...
      <footer className="mt-10 text-sm text-muted-foreground">
        ...
        <span className="font-semibold">SkyLimTech Inc™</span> — All rights reserved.
      </footer>
    </div>
  );
};
